...
public class _AMI_AsyncServerHandlerStub
	...
	implements demo.ami.AMI_AsyncServerHandler
{
	/** Serial version UID. */
	...
	public final static java.lang.Class _opsClass = demo.ami.AMI_AsyncServerHandlerOperations.class;
	public void op2(int ami_return_val)
	{
		...
		else
		{
			...
			if( _so == null )
				continue;
			AMI_AsyncServerHandlerOperations _localServant = (AMI_AsyncServerHandlerOperations)_so.servant;
			try
			{
				_localServant.op2(ami_return_val);
	...
	public void op2_excep(org.omg.Messaging.ExceptionHolder excep_holder)
	{
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "op2_excep", _opsClass );
			if( _so == null )
				continue;
			AMI_AsyncServerHandlerOperations _localServant = (AMI_AsyncServerHandlerOperations)_so.servant;
			try
			{
				_localServant.op2_excep(excep_holder);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
	...
	public void operation_excep(org.omg.Messaging.ExceptionHolder excep_holder)
	{
		while(true)
		{
			if(! this._is_local())
			{
				...
				try
				{
					_os = _request( "operation_excep", true);
					((org.omg.CORBA_2_3.portable.OutputStream)_os).write_value (excep_holder );
					_is = _invoke(_os);
					return;
				}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "operation_excep", _opsClass );
			if( _so == null )
				continue;
			AMI_AsyncServerHandlerOperations _localServant = (AMI_AsyncServerHandlerOperations)_so.servant;
			try
			{
				_localServant.operation_excep(excep_holder);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
	...
	public void operation(int ami_return_val)
	{
		...
		else
		{
			...
			try
			{
				_localServant.operation(ami_return_val);
				if ( _so instanceof org.omg.CORBA.portable.ServantObjectExt) 
					((org.omg.CORBA.portable.ServantObjectExt)_so).normalCompletion();
				return;
			}
