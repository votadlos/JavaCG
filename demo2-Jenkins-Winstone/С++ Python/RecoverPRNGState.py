...
PRNGMillisDelta = 1000*10 #global value, maximum gap between PRNGMillis estimate and its real value
...
if __name__ == "__main__":
    start = time.time()
    print recoverPRNGState('95d3de1617927e7b494a80a4a50c2daf',1389037663000,1389037471803,"192.168.66.3","8080",3,20) #5s
    #print recoverPRNGState('3439187822907c37529816c06be6086c',1389723926000,1389722755000,"192.168.66.3","8080",5,37) #295s
